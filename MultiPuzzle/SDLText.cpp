...
SDLText::SDLText()
{
	Connect(std::bind(&SDLText::OnStartUp, this, std::placeholders::_1));
}
...
bool SDLText::LoadFont(const char & _pathFontFile, int _fontSize)
{
...
void SDLText::RenderSolidText(std::string& _text, SDL_Color& _textColor, int _x,
...
void SDLText::RenderShadedText(std::string& _text, SDL_Color& _backgroundColor, SDL_Color& _textColor, int _x,
	int _y, SDL_Renderer& _renderer)
{
	//Get rid of preexisting texture
	SDL_DestroyTexture(m_message);
...
void SDLText::RenderBlendedText(std::string& _text, SDL_Color& _textColor, int _x,
	int _y, SDL_Renderer& _renderer)
{
	//Get rid of preexisting texture
	SDL_DestroyTexture(m_message);
...
bool SDLText::OnStartUp(const FontData& _fontData)
{
	if (TTF_Init() < 0) {
